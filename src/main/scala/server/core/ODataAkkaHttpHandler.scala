...
import org.apache.olingo.server.core.{ODataHandler, ODataHandlerException, ODataHttpHandlerImpl}
...
/**
  ...
  */
class ODataAkkaHttpHandler(val oData: OData, val serviceMetadata: ServiceMetadata, val fm: ActorMaterializer)
  extends ODataHttpHandlerImpl(oData, serviceMetadata) {
